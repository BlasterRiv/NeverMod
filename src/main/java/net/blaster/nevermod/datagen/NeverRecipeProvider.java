...
public class NeverRecipeProvider extends RecipeProvider implements IConditionBuilder {
  ...
  protected void buildRecipes(RecipeOutput pRecipeOutput) {
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.NeverKey.get())
        ...
        .pattern("$$$")
        .pattern("###")
        .define('#', ModItems.AncientGold).define('&', ModItems.AbsorbGem)
        .define('$', Ingredient.of(ModItems.TeleportGem, ModItems.LinkingGem, ModItems.DimensionGem))
        .unlockedBy("has_gem", has(ModItems.AncientGold))
        .save(pRecipeOutput);
    oreSmelting(pRecipeOutput, List.of(ModItems.RawAncientGold), RecipeCategory.MISC, ModItems.AncientGold, 100f, 100,
        "AncientGold");
    oreBlasting(pRecipeOutput, List.of(ModItems.RawAncientGold), RecipeCategory.MISC, ModItems.AncientGold, 100f, 50,
        "AncientGold");
  }
  ...
  protected static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput pRecipeOutput,
      RecipeSerializer<T> pSerializer, AbstractCookingRecipe.Factory<T> pRecipeFactory, List<ItemLike> pIngredients,
