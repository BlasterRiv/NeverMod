    ...
    public static void gatherData(GatherDataEvent event){
        ...
        gen.addProvider(event.includeServer(),
                new LootTableProvider(
                        ...
                        List.of(new LootTableProvider.SubProviderEntry(NeverBlockLootTableProvider::new, LootContextParamSets.BLOCK)),
                        lookupPtovidrt
                )
        );
        gen.addProvider(event.includeServer(),
        ...
        //gen.addProvider(event.includeServer(), new NeverDataMapProvider(packOutput,lookupPtovidrt));
    }
