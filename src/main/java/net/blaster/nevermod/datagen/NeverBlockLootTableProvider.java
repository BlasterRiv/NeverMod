...
public class NeverBlockLootTableProvider extends BlockLootSubProvider implements LootTableSubProvider {
  ...
  protected NeverBlockLootTableProvider(HolderLookup.Provider registries) {
    super(Set.of(ModBlocks.NeverStone.asItem()), FeatureFlags.REGISTRY.allFlags(), registries);
  }
